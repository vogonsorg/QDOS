...
// get stack position so we can guess if we are going to overflow
	...
	r_timegraph = Cvar_Get("r_timegraph","0");
	r_zgraph = Cvar_Get("r_zgraph","0");
	r_graphheight = Cvar_Get("r_graphheight","10");
	r_clearcolor = Cvar_Get("r_clearcolor","2");
	...
	r_numsurfs = Cvar_Get("r_numsurfs", "0");
	r_numsurfs->description = "Report number of surfaces in use.";
	r_reportedgeout = Cvar_Get("r_reportedgeout", "0");
	r_reportedgeout->description = "Report running out of edges.";
	r_maxedges = Cvar_Get("r_maxedges", "0");
	r_maxedges->description = "Maximum number of edges to draw.  This value may need to be raised if you see disappearing geometry.";
	r_numedges = Cvar_Get("r_numedges", "0");
	r_numedges->description = "Report number of edges in use.";
	r_aliastransbase = Cvar_Get("r_aliastransbase", "200");
	r_aliastransadj = Cvar_Get("r_aliastransadj", "100");
	r_maxbmodeledges = Cvar_Get("r_maxbmodeledges", "0"); /* FS: For big boy mods */
